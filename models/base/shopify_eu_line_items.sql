{%- set schema_name,
        ...
        shop_table_name
        = 'shopify_raw_eu', 'order', 'order_line', 'order_line_refund', 'shop' -%}
...
{%- set order_line_raw_tables = dbt_utils.get_relations_by_pattern('shopify_raw_eu%', 'order_line') -%}
{%- set order_line_refund_raw_tables = dbt_utils.get_relations_by_pattern('shopify_raw_eu%', 'order_line_refund') -%}
...
WITH 
    ...
    {%- set conversion_rate = 1 if var('sho_eu_currency') != 'USD' else 'conversion_rate' %}    
