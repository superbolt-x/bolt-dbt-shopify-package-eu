{%- set schema_name,
        ...
        variant_table_name,
        tag_table_name
        = 'shopify_raw_eu', 'product', 'product_variant', 'product_tag'-%}
...
{%- set product_raw_tables = dbt_utils.get_relations_by_pattern('shopify_raw_eu%', 'product') -%}
{%- set variant_raw_tables = dbt_utils.get_relations_by_pattern('shopify_raw_eu%', 'product_variant') -%}
{%- set tag_raw_tables = dbt_utils.get_relations_by_pattern('shopify_raw_eu%', 'product_tag') -%}
